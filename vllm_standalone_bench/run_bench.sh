...
# API 鉴权密钥（若服务端开启了 --api-key，填对应值；未开启则留空）
API_KEY="95e49ceafa1532608196ae9d8ccdb0654c41d2e4"
...
#
TOKENIZER="/work/development-code/Resource_Planning_Tool/model/Qwen2___5-0___5B-Instruct"
